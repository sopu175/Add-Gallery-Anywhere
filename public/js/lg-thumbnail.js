(function() {
    ...
    var Thumbnail = function(element) {
        ...
        this.thumbTotalWidth = (this.core.jQueryitems.length * (this.core.s.thumbWidth + this.core.s.thumbMargin));
    ...
    Thumbnail.prototype.build = function() {
        ...
        if (this.core.s.animateThumb) {
            _this.jQuerythumbOuter.css('height', _this.core.s.thumbContHeight + 'px');
        }
        ...
        if (_this.core.s.dynamic) {
            ...
            _this.core.jQueryitems.each(function(i) {
                ...
                if (!_this.core.s.exThumbImage) {
                    getThumb(jQuery(this).attr('href') || jQuery(this).attr('data-src'), jQuery(this).find('img').attr('src'), i);
                } else {
                    getThumb(jQuery(this).attr('href') || jQuery(this).attr('data-src'), jQuery(this).attr(_this.core.s.exThumbImage), i);
                }
        ...
        jQuerythumb.each(function() {
            ...
            if (vimeoVideoId) {
                jQuery.getJSON('//www.vimeo.com/api/v2/video/' + vimeoVideoId + '.json?callback=?', {
                    format: 'json'
                }, function(data) {
                    jQuerythis.find('img').attr('src', data[0][_this.core.s.vimeoThumbSize]);
                });
            }
        });
        ...
        _this.core.jQueryel.on('onBeforeSlide.lg.tm', function() {
            jQuerythumb.removeClass('active');
            jQuerythumb.eq(_this.core.index).addClass('active');
        });
        ...
        jQuery(window).on('resize.lg.thumb orientationchange.lg.thumb', function() {
            setTimeout(function() {
                _this.animateThumb(_this.core.index);
                _this.thumbOuterWidth = _this.jQuerythumbOuter.width();
            }, 200);
        ...
        if (this.core.s.animateThumb) {
            ...
            if (this.core.lGalleryOn) {
                if (!jQuerythumb.hasClass('on')) {
                    this.core.jQueryouter.find('.lg-thumb').css('transition-duration', this.core.s.speed + 'ms');
                }
    ...
    Thumbnail.prototype.enableThumbDrag = function() {
        ...
        _this.core.jQueryouter.find('.lg-thumb').on('mousedown.lg.thumb', function(e) {
            if (_this.thumbTotalWidth > _this.thumbOuterWidth) {
                ...
                _this.jQuerythumbOuter.removeClass('lg-grab').addClass('lg-grabbing');
            }
        });
    ...
    Thumbnail.prototype.enableThumbSwipe = function() {
        ...
        _this.core.jQueryouter.find('.lg-thumb').on('touchstart.lg', function(e) {
            if (_this.thumbTotalWidth > _this.thumbOuterWidth) {
                e.preventDefault();
    ...
    Thumbnail.prototype.toogle = function() {
        ...
        if (_this.core.s.toogleThumb) {
            ...
            _this.jQuerythumbOuter.append('<span class="lg-toogle-thumb lg-icon"></span>');
            _this.core.jQueryouter.find('.lg-toogle-thumb').on('click.lg', function() {
    ...
    Thumbnail.prototype.destroy = function() {
        if (this.core.s.thumbnail && this.core.jQueryitems.length > 1) {
            jQuery(window).off('resize.lg.thumb orientationchange.lg.thumb keydown.lg.thumb');
